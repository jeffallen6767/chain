  ...
  var 
    ...
    mine = function(options, callback) {
      ...
      var
        ...
        kernel_source = KERNEL_OPENCL || get_KERNEL_OPENCL(),
        programSource = kernel_source.replace(
      ...
      if (difficulty) {
        ...
        prepareToMine = function() {
          ...
          outBufferMem = cl.createBuffer(opencl_context, cl.MEM_WRITE_ONLY | cl.MEM_USE_HOST_PTR, outSize, outBuffer);
          
          // MEM_READ_ONLY: contains starting byte values
          inBufferMem = cl.createBuffer(opencl_context, cl.MEM_READ_ONLY | cl.MEM_USE_HOST_PTR, inSize, inBuffer);
          ...
          mineOnce = function() {
            ...
            if (cl.createCommandQueueWithProperties !== undefined) {
              // OpenCL 2
              queue = cl.createCommandQueueWithProperties(opencl_context, device, []);
            } else {
              // OpenCL 1.x
              queue = cl.createCommandQueue(opencl_context, device, null);
            }
            ...
            if (dataview) {
              ...
              cl.releaseContext(opencl_context);
